...
# ✅ เพิ่ม Variable ใหม่: executive_summary_header_html (เพิ่มต่อจาก executive_summary_html_elements_begin)
executive_summary_header_html = '''
    <div class="header">
        <div class="logo">
            <img src="/Users/sahutsky22/Downloads/report_ai-1/assets/logos/Polarlyst.jpg" alt="Polarlyst Logo">
        </div>
        <div class="subtitle">NEO COP<br>(NEO.BK/NEO TB)</div>
        <div class="header-half-circle"></div>
    </div>
    '''
...
__all__ = ['executive_summary_html_elements_begin', 'report_html_elements_begin', 'report_html_elements_end',
           'references_html_element_begin', 'references_html_element_end', 'executive_summary_header_html'] # ✅ เพิ่ม 'executive_summary_header_html' ใน __all__